...
type State = {
  ...
  xAxisLabelPosition: any;
  yAxisLabelPosition: any;
...
type Action =
  ...
  | { type: "SET_AXIS_SCALE"; payload: any }
  | { type: "SET_SCATTER_RADIUS"; payload: number }
  | { type: "SET_X_AXIS_LABEL_POSITION"; payload: any }
  | { type: "SET_Y_AXIS_LABEL_POSITION"; payload: any }
